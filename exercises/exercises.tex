...
Derive the coordinatewise updates for mean field VB to fit the mean and variance of a univariate Gaussian. \emph{The solution is in \citep[Section 21.5.1]{Mu12}}.
