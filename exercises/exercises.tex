...
\subsection{Linear regression with a Gaussian prior}
...
\subsection{LDA($\star$)}
Rederive all conditionals in the LDA and collapsed LDA model. Hint: use \eqref{e:joint}.
