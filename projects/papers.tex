...
For the paper your group will have chosen, you should: (1) explain the contents of the paper at a high level, (2) emphasize the strong and weak points of the paper, and (3) apply it to real data of your choice when applicable. 
...
Please fill the form {\bf before 23:59 on Wednesday 12 February.}. 
...
\end{itemize} to \href{mailto:remi.bardenet@gmail.com,gabriel.victorino_cardoso@minesparis.psl.eu,julyan.arbel@inria.fr}{all three teachers}\footnote{If the link does not work, this means
\href{mailto:remi.bardenet@gmail.com}{remi.bardenet@gmail.com}, \href{mailto:gabriel.victorino_cardoso@minesparis.psl.eu}{gabriel.victorino\_cardoso@minesparis.psl.eu} and \href{mailto:julyan.arbel@inria.fr}{julyan.arbel@inria.fr}.} {\bf no later than 20 March, 23:59}. 
We will then meet on 27 March for presentations (format TBD depending on number of groups).
