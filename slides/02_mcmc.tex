...
\begin{frame}{On the Harris-recurrence of the MH chain}
...
Consider a physical system described by Hamiltonian $H(x,\xi)$ in phase space $(q,p)\in \mathbb{R}^{2d}$. Then the trajectories are prescribed by
\begin{equation}
  \label{e:hamilton}
