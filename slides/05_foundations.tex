...
\begin{frame}
\frametitle{The likelihood principle \citep{BeWo82}}
...
\begin{itemize}
  ...
  \item However, full expected utilities are different:
  \begin{align*}
    \int L(a,s_1) p_1(x_1\vert\theta)p(\theta) \unn{\d x_1}\d\theta &=  \int L(a,s_2) \un{C(x_2)} p_2(x_2\vert\theta)p(\theta) \unn{\d x_2}\d\theta\\
...
% ###############################################
\section{Subjective (ot "personalist") Bayesians}
% ###############################################
\begin{frame}
