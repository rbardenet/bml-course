...
\begin{center}
\visible<3->{\adjincludegraphics[width=.6\textwidth,trim={0 {.1\height} 0 {.12\height}},clip]{figures_julyan/introRPM/prior_K_n_PY.pdf}\\
}
\end{center}
\end{frame}
...
\begin{frame}{HDP. Chinese Restaurant Franchise}
...
\begin{frame}{HDP. Stick-breaking representation}
	\begin{columns}
	...
	\begin{itemize}[<+->]
		\item \question{What can you say of the SB of the second-layer $G_i$'s?}
		\item 	\question{Hint: $G_0$ is itself a draw from a DP, meaning it has its own SB representation.}
	\end{itemize}
\end{column}
\begin{column}{0.5\textwidth}
    \begin{center}
...
\begin{frame}{Three-parameter IBP}
