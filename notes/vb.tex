...
Combined with the fact that the log term in the reverse KL \eqref{e:VB} favours a $q^\star$ with a support that includes that of $\pi$, this often implies a gross overestimation of the support of the target, along with the expected ignorance of correlations; see Figure~\ref{}.
