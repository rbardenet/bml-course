...
\addbibresource{biblio_julyan.bib} % BibTeX bibliography file
\addbibresource{references_gen.bib} % BibTeX bibliography file
...
\newenvironment{axiom}[1]{\renewcommand\theinneraxiom{#1}\inneraxiom}{\endinneraxiom}
