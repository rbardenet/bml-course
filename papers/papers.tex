...
\newcites{G}{\large Lecture on Generative priors}
\newcites{H}{\large Lecture on SBI}
...
\author{Julyan Arbel, R\'emi Bardenet, Gabriel Victorino Cardoso}
\maketitle
...
For the paper your group will have chosen, you should: (1) explain the theoretical, computational and/or empirical methods developed in the paper, (2) emphasize the strengths and weaknesses of the paper, and (3) apply it to real data of your choice when applicable. 
We expect you to be creative and add something insightful that is not in the original paper: this can be a theoretical point, an alternative illustrative experiment, etc. The whole point is to read the paper with a critical mind.
Finally, do not hesitate to pick longer or more difficult papers: we are aware of the diversity in difficulty, and we will take it into account.

\section{Assignment of papers}
As a first step, we ask each group to fill the spreadsheet at
\begin{center}
   TBC: \href{https://lite.framacalc.org/cdlr2k2rpq-9sey}{https://lite.framacalc.org/cdlr2k2rpq-9sey}
\end{center}
with the title of the paper, a link to it (if available), and the composition of the group.
We ask that you fill in the form {\bf before Wednesday 25 February}. 
...
\begin{itemize}
\item one report as a pdf ($\leq 5$ pages, all included) in the \href{https://www.overleaf.com/latex/templates/neurips-2020/mnshsmqkjsqz}{NeurIPS template},
...
\end{itemize} to \href{mailto:julyan.arbel@inria.fr,remi.bardenet@gmail.com,gabriel.victorino_cardoso@minesparis.psl.eu}{all teachers}\footnote{if the above link is broken, this means: \href{mailto:julyan.arbel@inria.fr}{julyan.arbel@inria.fr}, \href{mailto:remi.bardenet@gmail.com}{remi.bardenet@gmail.com}, and \href{gabriel.victorino_cardoso@minesparis.psl.eu}{gabriel.victorino\_cardoso@minesparis.psl.eu}} {\bf no later than Monday 9 March, 23:59}. There will be no deadline extension.

The last step of your project will be a presentation in front of the class on Thursday 12 March.
...
\bibliographyG{part7.bib}
\bibliographyH{part8.bib}
\end{document}
